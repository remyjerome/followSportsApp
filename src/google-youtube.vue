...
import EvolutionMensuration from './EvolutionMensuration.vue'
  ...
  export default {
    ...
    data: () => ({
      drawer: null,
      items: [
        { icon: 'trending_up', text: 'Suivi Mensuration' },
        { icon: 'subscriptions', text: 'Programation Entrainement' },
        { icon: 'featured_play_list', text: 'Carnet de Musculation' },
        { icon: 'watch_later', text: 'Scheduler' }
      ],
      items2: [
